...
#
message("${Blue}Use GNU ARM toolchain GCC-7.3.1${ColourReset}")
set(WIN_TOOLCHAIN_PATH "d:/devtools/GNU_ARM/7 2018-q2-update" CACHE PATH "Windows toolchain for GNU ARM") 
set(UNIX_TOOLCHAIN_PATH "/Applications/ARM/gcc-arm-none-eabi-7-2018-q2-update" CACHE PATH "Unix toolchain for GNU ARM") 
...
set(CMAKE_C_COMPILER ${TOOLCHAIN_PATH}/bin/${COMPILER_PREFIX}-gcc${TOOLCHAIN_FILE_EXTENSION})
set(CMAKE_CXX_COMPILER ${TOOLCHAIN_PATH}/bin/${COMPILER_PREFIX}-g++${TOOLCHAIN_FILE_EXTENSION})
set(CMAKE_ASM_COMPILER ${TOOLCHAIN_PATH}/bin/${COMPILER_PREFIX}-gcc${TOOLCHAIN_FILE_EXTENSION})
set(CMAKE_ASM_FLAGS -c)

# define executebals for USER commands
set(CMAKE_SIZE ${TOOLCHAIN_PATH}/bin/arm-none-eabi-size${TOOLCHAIN_FILE_EXTENSION})
