...
#
message( CHECK_START  "${Blue}Check for toolchain GCC-12.3Rel1${ColourReset}")
set(WIN_TOOLCHAIN_PATH "D:/devtools/GNU_ARM/12.3 rel1" CACHE PATH "Windows toolchain for GNU ARM") 
set(UNIX_TOOLCHAIN_PATH "/Applications/ArmGNUToolchain/12.3.Rel1/arm-none-eabi" CACHE PATH "Unix toolchain for GNU ARM") 
...
# Avoid linker warning when compiling with GCC 12
# see https://github.com/raspberrypi/pico-sdk/issues/1029 for further informations 
set(TOOLCHAIN_LINKER_FLAGS  "LINKER:--no-warn-rwx-segments" CACHE STRING "") 
